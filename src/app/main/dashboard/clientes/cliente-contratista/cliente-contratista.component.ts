...
@Component({
  selector: 'app-cliente-contratista',
  templateUrl: './cliente-contratista.component.html',
  styleUrls: ['./cliente-contratista.component.scss'],
  providers:
    [I18n, { provide: NgbDatepickerI18n, useClass: CustomDatepickerI18n }]
})
export class ClienteContratistaComponent implements OnInit {
  ...
  onSetContratistaCliente() {
    ...
    this.contratistasService.contratistaCliente_List({
      idCliente: this.currentUser.idUserTablaUsuario,
      idContratista: 0,
  ...
  onClickCtr(value) {
    this.idEstadoContratista = value;
    this.onSetContratistaCliente();
